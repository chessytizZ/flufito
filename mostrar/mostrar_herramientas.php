    ...
    <table class="table table-striped table-striped" id="ajustes">
        ...
        <?php
           ...
           <tr>
             ...
             <td><a class='btn editar' id="opciones" href="editar_herramientas.php?id=<?php echo $row['id']; ?>"> Editar</a></td>
             <td><a class='btn eliminar' id="opciones" href="eliminar_herramientas.php?id=<?php echo $row['id']; ?>"> Eliminar</a></td>
           </tr>
        <?php
        }
        ?>
